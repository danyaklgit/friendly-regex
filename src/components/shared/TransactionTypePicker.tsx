        ...
        <div
          ...
          <div className="p-2 border-b border-border-subtle">
            <div className="relative">
              ...
              />
              {/* Clear-search × button. Visible only while the input
                  has a value so the search icon on the left is the
                  only chrome at rest; clicking the × empties the
                  query and re-focuses the input so the operator can
