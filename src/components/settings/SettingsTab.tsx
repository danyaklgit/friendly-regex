...
import { SamplingVocabularyPage } from './SamplingVocabularyPage';
...
const SUB_TABS = [
  ...
  { key: 'sampling', label: 'Sampling vocabulary', icon: 'M4 6h16M6 12h12M9 18h6', tour: 'settings-subtab-sampling' },
] as const;
  ...
  return (
    <div className={`flex gap-0 ${heightClass}`}>
      ...
      <div className="flex-1 p-4 overflow-hidden min-h-0 flex flex-col">
        ...
        {activeSubTab === 5 && <SamplingVocabularyPage />}
      </div>
    </div>
  );
}
